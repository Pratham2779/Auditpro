...
import { Search, Calendar, User, MapPin, Filter, Download, Eye, FileText, Clock, CheckCircle, AlertCircle, Flag, File } from 'lucide-react';
...
export default function AuditorAuditHistory() {
  ...
  const allSalesman = useMemo(() => {
    const salesmen = new Set();
    auditLogs.forEach(log => {
      if (log.salesman && log.salesman.fullName) {
        salesmen.add(log.salesman.fullName);
      }
    });
  ...
  const auditedCount = useMemo(() => 
    auditLogs.filter(log => log.auditStatus === 'audited').length, 
    [auditLogs]
  );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-base font-medium text-gray-600">Audited</p>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  onChange={handleFilterChange(setFilterSalesman)}
                  className="appearance-none bg-white border border-gray-300 rounded-xl pl-10 pr-8 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-base"
                >
